...
export const About: React.FunctionComponent<{}> = () => {
    ...
    return (<div id={Style.About} >
        ...
        <p id={Style.logosText}> | Typescript | Javascript | Git | React | Redux | HTML | Sass | CSS | Figma | NodeJs  | Express | Postman | PostgreSQL | SQLite | Prisma | Sequelize | Kotlin | Babel | Electron | Firebase | MongoDB | Mongoose | React Native |</p>
